...
<div class="max-w-sm mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-lg font-bold mb-4">ユーザー編集</h1>
    ...
    <form method="POST" action="{{ route('company.users.update', $user) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" value="{{ old('name', $user->name) }}" data-testid="name-input" class="border rounded w-full px-2 py-1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="email" value="{{ old('email', $user->email) }}" data-testid="email-input" class="border rounded w-full px-2 py-1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="birth_date" placeholder="YYYY-MM-DD" value="{{ old('birth_date', optional($user->birth_date)->format('Y-m-d')) }}" data-testid="birth-date-input" class="border rounded w-full px-2 py-1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="hire_date" placeholder="YYYY-MM-DD" value="{{ old('hire_date', optional($user->hire_date)->format('Y-m-d')) }}" data-testid="hire-date-input" class="border rounded w-full px-2 py-1">
        ...
        <button type="submit" data-testid="user-submit" class="bg-blue-600 text-white px-4 py-2 rounded w-full">更新</button>
    </form>
</div>
@endsection
