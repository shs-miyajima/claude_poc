...
<div class="max-w-md mx-auto">
    <h1 class="text-[22px] font-bold text-text-primary mb-6">ユーザー登録</h1>
    ...
    <div class="rounded-[13px] border border-border-card bg-card-bg p-6">
        <form method="POST" action="{{ route('company.users.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" data-testid="name-input"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="email" value="{{ old('email') }}" data-testid="email-input"
                       class="border border-border-input rounded-[8px] w-full px-3 py-2 text-[13.5px] text-text-primary focus:outline-none focus:ring-2 focus:ring-accent-soft-border focus:border-accent">
                @error('email')<div class="text-danger text-[12.5px] mt-1" data-testid="email-error">{{ $message }}</div>@enderror
            </div>
            <div class="mb-4">
                <label class="block text-[13px] font-medium text-text-secondary mb-1">初期パスワード</label>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="birth_date" placeholder="YYYY-MM-DD" value="{{ old('birth_date') }}" data-testid="birth-date-input"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="hire_date" placeholder="YYYY-MM-DD" value="{{ old('hire_date') }}" data-testid="hire-date-input"
                       class="border border-border-input rounded-[8px] w-full px-3 py-2 text-[13.5px] text-text-primary placeholder:text-text-placeholder focus:outline-none focus:ring-2 focus:ring-accent-soft-border focus:border-accent">
